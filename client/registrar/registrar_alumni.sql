...
CREATE TABLE `reg_transaction` (
  `id` int NOT NULL AUTO_INCREMENT,
  `request_code` varchar(100) CHARACTER SET utf8mb4 DEFAULT NULL,
...
(6,'Certification, Verification, Authentication (CAV/Apostile)',NULL),
(7,'Certificates \r\nof Attendance\r\n',NULL),
(8,'Certificate of Graduation',NULL),
(9,'Certificate of Medium of Instruction',NULL),
(10,'Certificate of General Weighted Average (GWA)',NULL),
(11,'Non-Issuance of Special Order ',NULL),(12,'Certified True Copy',NULL),
(13,'Course/Subject \r\nDescription)\r\n',NULL),
(14,'Certificate of Transfer Credential/Honorable Dismissal',NULL),
(15,'Transcript of \r\nRecords (First Copy)\r\n',NULL),
(16,'Transcript of Records (Second and succeeding copies)',NULL),
(17,'Transcript of Records (Copy for Another School)',NULL),
(18,'Course Accreditation Service-Senior High School to Bridge Course',NULL),
(19,' Course Accreditation Service (For Shiftees and \r\nRegular Students)\r\n',NULL),
(20,'Course Accreditation Service (for Transferees)',NULL),
(21,'Informative Copy of Grades',NULL),
(22,'Leave of Absence',NULL),
