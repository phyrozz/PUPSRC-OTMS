			...
			<ul class="navbar-nav me-auto order-2 order-lg-1">
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="officeServicesDropdown">
						...
						<li><a class="dropdown-item" href="/client/academic.php">Academic</a></li>
						<li><a class="dropdown-item" href="/client/accounting/index.php">Accounting</a></li>
						<li><a class="dropdown-item" href="/client/administrative.php">Administrative Services</a></li>
					</ul>
				</li>
					...
					<ul class="dropdown-menu" aria-labelledby="officeServicesDropdown">
						<?php switch ($office_name) { 
                            case 'Guidance Office':
                                echo '
                                <li><a class="dropdown-item" href="/client/guidance/counceling.php">Schedule Counceling</a></li>
                            ...
                            case 'Academic Office':
                                echo '
                                <li><a class="dropdown-item" href="/client/academic/subject_overload.php">Subject Overload</a></li>
                                <li><a class="dropdown-item" href="/client/academic/grade_accreditation.php">Grade Accreditation</a></li>
                                <li><a class="dropdown-item" href="/client/academic/cross_enrollment.php">Cross-Enrollment</a></li>
                                <li><a class="dropdown-item" href="/client/academic/shifting.php">Shifting</a></li>
                                <li><a class="dropdown-item" href="/client/academic/manual_enrollment.php">Manual Enrollment</a></li>
                                <li><a class="dropdown-item" href="/client/academic/servicesinsistools.php">Services in SIS Tools</a></li>
                                ';
                                break;
                            ...
                            case 'Registrar Office':
                                ...
                                <li><a class="dropdown-item" href="/client/registrar/your_transaction.php">Registrar Transaction History</a></li>
                                ';
                                break;
                            case 'Accounting Office':
                                echo '
                                <li><a class="dropdown-item" href="/client/accounting/payment1.php">Payment</a></li>
                                <li><a class="dropdown-item" href="/client/accounting/others/offsetting1.php">Offsetting</a></li>
