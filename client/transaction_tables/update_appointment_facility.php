...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_id'])) {
    ...
    $updateQuery = "UPDATE appointment_facility SET start_date_time_sched = ?, end_date_time_sched = ?, facility_id = ?, client = ? WHERE appointment_id = ?";
    $stmt = $connection->prepare($updateQuery);
    $stmt->bind_param("sssss", $startDateTime, $endDateTime, $facility, $client, $editId);
    ...
    if ($stmt->execute()) {
        ...
        echo "Error occurred while updating appointment";
    }
