...
class PHPMailer
{
     ...
     * Returns '192.168.84.183.localdomain' if unknown.
     *
     * @return string
     */
    protected function serverHostname()
    {
        ...
        if (!static::isValidHost($result)) {
            return '192.168.84.183.localdomain';
        }
