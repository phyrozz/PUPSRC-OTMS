      ...
      <div class="container-fluid p-4">
            <nav class="breadcrumb-nav" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Request of Equipment</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="card-body">
                    <form class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="equipname" class="form-control" id="equipname" disabled>
                        </div>
                        <div class="col-md-6">
                            <label for="quantityequip" class="form-label">Quantity</label>
                            <input type="quantityequip" class="form-control" id="equip">
                        </div>
                        ...
                        <div class="col-12">
                            <label for="purposeReq" class="form-label">Purpose of Request</label>
                        ...
                        <div class="alert alert-info" role="alert">
                            ...
                            <p class="mb-0">Please present your requisition slip on your scheduled appointment</p>
                        </div>
                        ...
                        <div class="d-flex w-100 justify-content-between p-1">
                            ...
                            <a href="generate-pdf.php" class="btn btn-primary w-25">Submit</a>
