...
$documentRequestsQuery = "SELECT request_id, office_name, request_description, scheduled_datetime, status_name, amount_to_pay
                        ...
                        WHERE user_id = " . $_SESSION['user_id'] . " AND office_name = 'Guidance Office' AND request_description != 'Guidance Counseling'";
...
if ($result) {
    ...
    $totalRecordsQuery = "SELECT COUNT(*) AS total_records
                          FROM doc_requests
                          WHERE user_id = " . $_SESSION['user_id'] . " AND office_id = 5 AND request_description != 'Guidance Counseling'";
