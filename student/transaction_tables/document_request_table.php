    ...
    <table id="transactions-table" class="table table-hover hidden">
        <thead>
            <tr>
                ...
                <th class="text-center doc-request-amount-header sortable-header" data-column="5" scope="col" data-order="desc">
                    Amount to pay
                    <i class="sort-icon fa-solid fa-caret-down"></i>
                </th>
                <th class="text-center doc-request-status-header sortable-header" data-column="6" scope="col" data-order="desc">
                    Status
                    <i class="sort-icon fa-solid fa-caret-down"></i>
                </th>
                <th class="text-center"></th>
