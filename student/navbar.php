                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userProfileDropdown">
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="helpDropdown">
                                ...
                                <li><a class="dropdown-item" href="http://pup.otms.local/student/guidance/help.php">Guidance Office</a></li>
                                <li><a class="dropdown-item" href="#">Academic Office</a></li>
                                <li><a class="dropdown-item" href="#">Accounting Office</a></li>
                                <li><a class="dropdown-item" href="http://pup.otms.local/student/administrative/help.php">Administrative Office</a></li>
                            </ul>
                        </li>
