...
<nav class="navbar navbar-expand-lg navbar-dark bg-maroon p-3">
    <div class="container-fluid">
        <img class="p-2" src="http://192.168.84.183/assets/pup-logo.png" alt="PUP Logo" width="40">
        <a class="navbar-brand" href="http://192.168.84.183/student/home.php"><strong>PUPSRC-OTMS</strong></a>
            ...
            <ul class="navbar-nav me-auto order-2 order-lg-1">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="officeServicesDropdown">
                        <li><a class="dropdown-item" href="http://192.168.84.183/student/registrar.php">Registrar</a></li>
                        <li><a class="dropdown-item" href="http://192.168.84.183/student/guidance.php">Guidance</a></li>
                        <li><a class="dropdown-item" href="http://192.168.84.183/student/academic.php">Academic</a></li>
                        <li><a class="dropdown-item" href="http://192.168.84.183/student/accounting.php">Accounting</a></li>
                        <li><a class="dropdown-item" href="http://192.168.84.183/student/administrative.php">Administrative Services</a></li>
                    </ul>
                </li>
            ...
            <ul class="navbar-nav order-3 order-lg-3 w-50 gap-3">
                ...
                <li class="nav-item dropdown order-1 order-lg-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userProfileDropdown">
                        <li><a class="dropdown-item" href="http://192.168.84.183/student/transactions.php">My Transactions</a></li>
                        <li><a class="dropdown-item" href="http://192.168.84.183/student/my_account.php">Account Settings</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="http://192.168.84.183/sign_out.php"><i class="fa-solid fa-right-from-bracket"></i> Log Out</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<script>
    function handleSearchAutocomplete(input) {
        ...
        $.ajax({
        url: 'http://192.168.84.183/autocomplete.php',
        method: 'POST',
        data: { query: query },
