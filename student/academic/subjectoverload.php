...
<head>
    ...
    <link rel="stylesheet" href="academicmodal.css">
...
<div class="wrapper">
        ...
        <!-- The Modal -->
            ...
            <h2><br/>Are you a student in good standing?</h2>
            ...
            <button type="button" class="btn btn-primary" id="nextButton" onclick="openModal2()" disabled>Next</button>
            <!-- <span id="countdownText" class="countdown"></span> -->
            </div>
        </div>

        <!-- When answered No Modal-->
            <div id="redirectModal" class="modal answeredno">
            <div id="modalContent" class="modal-content">
            <button type="button" class="btn-close" aria-label="Close" onclick="closeModal()"></button>
            <img src="/assets/exclamation.png" class="exclamationpic">
            <h2><br/>Subject overload is only allowed for academically outstanding students.</h2>
            <button type="button" class="btn btn-primary" id="nextButton" onclick="redirectHome()">Home</button>
            <!-- <span id="countdownText" class="countdown"></span> -->
            </div>
        </div>
