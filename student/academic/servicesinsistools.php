...
<div class="wrapper">
        ...
        <div id="payModal" class="modal">
            ...
            <br/><h2>You will complete this transaction in the SIS Tools Website</h2>
        ...
        <nav class="breadcrumb-nav breadcrumb-container" aria-label="breadcrumb">
            ...
            <p class="header-text text-center text-light">(a) ACE Form - Add subjects or change your officially enrolled subjects,<br/>(b) Subject Petition/Tutorial - Request for subject not offered in current semester</p>
        </div>
...
<input value="Done" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#confirmModal" />
                            ...
                            <div class="modal fade modal-dark" id="confirmModal" tabindex="-1" aria-labelledby="confirmSubmitModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <h5><center>Are you sure you want to go back to list of services?</center></h5>
                                    </div>
