...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog editmod" role="document">
    <div class="modal-content">
      ...
      <form action="generatepdf_ce.php" method="POST" id="CEform">
      <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                  <label for="input22">Branch</label>
                  <input type="text" maxlength="20" class="form-control" id="input22" name="branch" placeholder="Maragondon" required>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="input13" name="units2" min="0">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="input16" name="units3" min="0">
                </div>
              </div>
            </div>
