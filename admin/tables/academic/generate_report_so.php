...
$query = "SELECT overload_letter, ace_form, cert_of_registration, overload_letter_status.status_name AS overload_letter_status, ace_form_status.status_name AS ace_form_status, cert_of_registration_status.status_name AS cert_of_registration_status, 
