...
$query = "SELECT application_letter, application_letter_status.status_name AS application_letter_status, 
        ...
        INNER JOIN acad_status AS application_letter_status ON acad_cross_enrollment.application_letter_status = application_letter_status.academic_status_id";
if (!empty($searchTerm)) {
...
$fileName = 'academic_ce_report'. '_'.  $NameModified . '_' . uniqid(). '.pdf';
